...
const Page3: React.FC<PageProps> = ({ onRouteChange }) => {
    return (
        <Box textAlign="center">
            <Box>
                <Image src={logo} fallbackSrc={logo} alt="logo image" mx="auto" />
                <Heading as="h1" size="2xl" fontFamily="monospace" fontWeight={200} color="green.800" m={5}>Code-Splitting Page 3</Heading>
            </Box>
            ...
            <Button colorScheme="orange" size="lg" isDisabled>Page 3</Button>
        </Box>
    );
};
